...
struct Theater {
    ...
    static var defaultAnnotaion =  Theater(
        type: .none,
        location: "청년취업사관확교 영등포 캠퍼스",
        latitude: 37.517829,
...
struct TheaterList {
    ...
    static var mapAnnotations: [Theater] = [
        ...
        Theater(type: .mega, location: "메가박스 이수", latitude: 37.48581351541419, longitude:  126.98092132899579),
        Theater(type: .mega, location: "메가박스 강남", latitude: 37.49948523972615, longitude: 127.02570417165666),
